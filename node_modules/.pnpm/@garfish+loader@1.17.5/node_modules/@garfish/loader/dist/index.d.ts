...
declare type CommonRender = (node: Node, parent: Element) => {
...
declare class TemplateManager {
    ...
    createElements(renderer: Renderer, parent: Element, commonRender?: CommonRender): Element[];
...
declare class JavaScriptManager {
    ...
    setDefferAttribute(val: boolean): void;
    setDep(node: Node): void;
    isSameOrigin(node: Node): boolean;
    clone(): any;
}
