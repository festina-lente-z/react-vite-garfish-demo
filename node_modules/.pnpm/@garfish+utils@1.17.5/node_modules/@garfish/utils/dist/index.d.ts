...
declare function safeWrapper(callback: (...args: Array<any>) => any, disableWarn?: boolean): void;
...
declare function changeTagNameToLowerCase(tagName: string): string;
...
declare const coreLog: createDebug.Debugger;
declare const routerLog: createDebug.Debugger;
